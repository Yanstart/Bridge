...
% --- Macro \offlogo : inclut un logo officiel a hauteur uniforme -----
% Boite max 18mm x 5mm, aspect ratio preserve. Les logos vivent dans
% figures/logos/. Sources : Wikipedia Commons, sites officiels.
% Nom \offlogo et non \logo car \logo est deja reserve par Beamer.
\newcommand{\offlogo}[1]{%
  \raisebox{-0.4ex}{%
    \includegraphics[width=18mm,height=5mm,keepaspectratio]{figures/logos/#1}%
  }%
}
...
\institute{EPHEC Brussels \\ TS6 : e-Health et appareils et dispositifs (para)m\'edicaux connect\'es}
\date{Mai 2026}
...
\begin{frame}{Les standards qui font le pont}
  \begin{center}
    ...
    \begin{tabularx}{\linewidth}{@{}c l l X@{}}
      ...
      \midrule
      \offlogo{hl7.png}                           & HL7 v2   & Entr\'ee Legacy & Format texte \`a barres verticales utilis\'e par 80~\% du parc hospitalier mondial. \\
      \offlogo{fhir.png}                          & FHIR R4  & Sortie moderne  & Norme HL7 r\'ecente, ressources REST/JSON, lisible par les DPI 2020+. \\
      \offlogo{loinc.png}                         & LOINC    & Codification    & Dictionnaire universel de codes pour mesures et observations cliniques. \\
      \offlogo{ihe.png}                           & IHE PCD  & Cadre intero.   & Profils IHE de connexion des dispositifs m\'edicaux au DPI. \\
...
\begin{frame}{Stack technologique}
  \begin{center}
    ...
    \begin{tabular}{@{}c l l@{}}
      ...
      \midrule
      \offlogo{python.png}                  & C\oe ur middleware     & Python 3.12 + FastAPI~\offlogo{fastapi.png} \\
      \offlogo{sqlite.png}                  & Persistance locale     & SQLite WAL chiffr\'e \\
      \offlogo{htmx.png}                    & Dashboard              & HTMX + WebSocket \\
      \textcolor{bridgeteal}{\faRedo}    & Transport s\'ecuris\'e & httpx + Tenacity (retry exponentiel) \\
      \offlogo{docker.png}                  & Orchestration          & Docker Compose \\
      \offlogo{hapi.png}                    & Cible FHIR             & HAPI FHIR Server (image officielle) \\
      \bottomrule
    \end{tabular}
  \end{center}
  \vspace{0.4em}
...
\begin{frame}{Quatre \'equipements, quatre canaux}
  \begin{center}
    ...
    \begin{tabular}{@{}c l l l l@{}}
      ...
      \midrule
      \offlogo{philips.png}     & Philips IntelliVue MX450 & Moniteur multiparam.    & TCP MLLP HL7v2        & SpO2, FC, PA \\
      \offlogo{masimo.png}      & Masimo Radical-7         & Oxym\`etre POC           & BLE \(\to\) MQTT JSON & SpO2, FC \\
      \offlogo{welchallyn.png}  & Welch Allyn CP150        & ECG 12 d\'erivations     & Fichier d\'epos\'e    & \'Etude ECG \\
      \offlogo{draeger.png}     & Dr\"ager Evita V500      & Ventilateur             & RS-232 MEDIBUS        & FiO2, PEEP, VT, FR \\
      \bottomrule
    \end{tabular}\\[2mm]
...
\begin{frame}[plain]{Place \`a la d\'emo}
  \vspace{0.8cm}
  \begin{center}
    \includegraphics[height=2.8cm,keepaspectratio]{figures/logos/docker.png}\\[6mm]
    {\Large\bfseries\color{bridgeblue} Maintenant, on lance.}\\[4mm]
